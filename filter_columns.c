/*
This file, filter_columns.c, is a part of the ddup program.
...
void
set_sensitivity (filter_entry *ep)
{
...
gboolean
subres (DupItem *item, user_data *udp)
{
...
gboolean
subname (DupItem *item, user_data *udp)
{
...
gboolean
filter_match (DupItem *item, user_data *udp)
{
...
void
apply_filters_cb (GtkWidget *self, user_data *udp)
{
...
void
name_buff_cb (GtkWidget *self, user_data *udp)
{
...
void
result_buff_cb (GtkWidget *self, user_data *udp)
{
...
void
and_cb (GtkCheckButton *self, user_data *udp)
{
...
// Set the or logic radio button to true of false

void
or_cb (GtkCheckButton *self, user_data *udp)
{
	if (gtk_check_button_get_active (self))
		udp->ep->or = TRUE;
	else
...
void
res_n_cb (GtkCheckButton *self, user_data *udp)
{
	if (gtk_check_button_get_active (self))
		udp->ep->res_n = TRUE;
	else
...
void
name_n_cb (GtkCheckButton *self, user_data *udp)
{
	if (gtk_check_button_get_active (self))
		udp->ep->name_n = TRUE;
	else
...
void
clear_filters_cb (GtkWidget *self, user_data *udp)
{
	gtk_window_close (GTK_WINDOW(udp->filter_window));
...
void
get_filters_cb (GtkWidget *self, user_data *udp)
{
