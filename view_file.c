...
void 
dumpStr (unsigned char *ip, int len_in, unsigned char *op, int offset) {
...
void read_and_make_strings(GtkStringList *str_list, const char *name, user_data *udp) {
...
{
	// Get the name of the file to view
