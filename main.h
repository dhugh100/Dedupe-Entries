...
// General
#define READ_BUFF 262144 // Arbitrary, sized to keep per-chunk overhead low when hashing
...
#define STR_EMP "Empty"
#define STR_ERR "Error"
#define STR_UNI "Unique"
#define STR_SPACE " "
#define STR_CONFIG "/.config/dedupe-entries.cfg"
